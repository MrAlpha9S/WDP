        ...
        >
            ...
            <div className="flex-1 px-5 py-4 flex flex-col gap-4 min-h-0 overflow-y-auto custom-scrollbar">
                ...
                <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded bg-white/5 border border-border flex items-center justify-center text-gray-400 flex-shrink-0">
                        <ScrollText size={20} />
                    </div>
            ...
            <div className="flex gap-2 px-5 py-3 border-t border-border flex-shrink-0">
                <button onClick={() => onEdit(rule)} className="flex-1 text-[12px] font-semibold bg-white/[0.05] hover:bg-white/[0.09] text-gray-300 py-2 rounded-lg transition-colors border border-border">
                    Edit Rule
                </button>
                {rule.isActive ? (
