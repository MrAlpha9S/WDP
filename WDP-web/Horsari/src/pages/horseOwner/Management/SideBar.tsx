...
const ITEMS: SidebarItem[] = [
  { tab: "Horses",      icon: <House size={17} /> },
  { tab: "Jockeys",     icon: <User size={17} /> },
  { tab: "Stable",      icon: <Building2 size={17} /> },
  { tab: "Marketplace", icon: <ShoppingBag size={17} /> },
  { tab: "Financials",  icon: <Wallet size={17} /> },
];
