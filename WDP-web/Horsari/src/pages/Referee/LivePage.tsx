...
import { RACE, LOGGED_INCIDENTS, HORSE_COLORS, HORSE_PROGRESS, CAMERAS } from "../../shared/data/RaceData";
import type { HorseEntry, IncidentType } from "../../shared/types/RaceTypes";
...
// ── Position track (mock live data — requires real-time socket feed) ──────────

function PositionTrack({ horses, showOnStream }: { horses: HorseEntry[]; showOnStream: boolean }) {
    return (
...
export default function LivePage() {
    const { wsConnected, wsCount, horses } = useRaceSocket();
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <PositionTrack horses={horses} showOnStream={showTrackOnStream} />
